...
<div class="flex flex-col flex-nowrap justify-center xl:flex-row xl:flex-wrap">
  <div
    ...
    class="flex-1 relative xl:order-first ease-out transform mx-auto xl:ml-0 xl:ml-12 xl:max-w-md">
    {#if browser}
      <Category />
      <MiniDash />
      <Action {post} />
  ...
  <!-- <div
    in:fly={{ x: 25, duration: 300, delay: 500 }}
    out:fly={{ x: 25, duration: 300 }}
    class="flex-1 xl:order-first ease-out mx-auto xl:ml-0 xl:ml-8 xl:max-w-md">
    <Profile2 />
  </div> -->
  <div
    in:fly={{ x: -25, duration: 300, delay: 500 }}
