...
<div class="flex flex-col flex-nowrap justify-center xl:flex-row xl:flex-wrap h-feed">
  <div
    ...
    class="flex-1 relative w-full max-w-screen-md order-first mx-auto xl:mr-0 xl:ml-8 xl:max-w-md">
    <Profile />
    <MiniDash />
  </div>
  <div>
    <div
      in:fly={{ x: -25, duration: 300, delay: 500 }}
      out:fly={{ x: -25, duration: 300 }}
      class="flex-1 w-full fixed max-w-screen-lg xl:order-last mx-auto xl:ml-0 xl:mr-12 xl:max-w-lg">
      <Home />
    </div>
    <div
      in:fly={{ x: -25, duration: 300, delay: 500 }}
